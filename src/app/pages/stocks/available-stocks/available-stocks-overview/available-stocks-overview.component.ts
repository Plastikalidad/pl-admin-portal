...
@Component({
  selector: 'app-available-stocks-overview',
  standalone: true,
  imports: [CommonModule, TableComponent, ActionMenuComponent, SearchComponent, AddStocksComponent, ConfirmModalComponent],
  templateUrl: './available-stocks-overview.component.html',
  styleUrl: './available-stocks-overview.component.scss'
})
export class AvailableStocksOverviewComponent {
  @ViewChild('addStock') addStock: AddStocksComponent | undefined;
